...
class Agent:
    ...
    def save_weights(self):
        self.actor.save_weights("mypanda_saved/actor_ppo", save_format="tf")
        self.actor_old.save_weights("mypanda_saved/actor_old_ppo", save_format="tf")
        self.critic.save_weights("mypanda_saved/critic_ppo", save_format="tf")
        self.critic_old.save_weights("mypanda_saved/critic_old_ppo", save_format="tf")

    def load_weights(self):
        self.actor.load_weights("mypanda_saved/actor_ppo")
        self.actor_old.load_weights("mypanda_saved/actor_old_ppo")
        self.critic.load_weights("mypanda_saved/critic_ppo")
        self.critic_old.load_weights("mypanda_saved/critic_old_ppo")
...
def main(
    ...
    value_clip = 7 # How many value will be clipped. Recommended set to the highest or lowest possible reward
